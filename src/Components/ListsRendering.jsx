...
export class List extends Component {
    ...
    render(){
       const names = this.state.names.map((name) => <h2>{name}</h2>);
        return (
            <>
            <h2>Employee Names</h2>
            <input type='button' onClick={this.clickHandler} value='Add Person'/>
            ...
            {/* {names} */}
              <Persons data={this.state.persons}/>
            </>
        )
    }
}